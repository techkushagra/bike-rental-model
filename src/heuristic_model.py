            ...
            for day_idx in range(NUM_DAYS):
                ...
                for i in DEPOTS:
                    ...
                    if i in REPAIR_DEPOTS:
                        ...
                        damaged_at["HSR_Layout"] += damaged_ret
                        if damaged_ret > 0.5:
                            transfers_record.append((i, "HSR_Layout", day, damaged_ret, "damaged"))
                    else:
                        damaged_at["Whitefield"] += damaged_ret
                        if damaged_ret > 0.5:
                            transfers_record.append((i, "Whitefield", day, damaged_ret, "damaged"))
